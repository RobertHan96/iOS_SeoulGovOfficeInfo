...
class DatafetchManager {
    ...
    let guOffice : [Office] = [
        Office(name: "종로", tel: "02-2148-1114", address: "서울특별시 종로구 삼봉로43",
               publicSite: "https://www.jongno.go.kr/portalMain.do",lat: 37.572896, lng: 126.979254 ),
        Office(name: "중구", tel: "02-3396-4114", address: "서울특별시 중구 창경궁로 17",
               publicSite: "http://www.junggu.seoul.kr/index.jsp",lat: 37.5636204, lng: 126.997976 ),
        Office(name: "성동", tel: "02-2286-5114", address: "서울특별시 성동구 고산자로 270",
        ...
        Office(name: "노원", tel: "02-2116-3114", address: "서울특별시 노원구 노해로 437",
        ...
        Office(name: "영등포", tel: "02-2670-3114", address: "서울특별시 영등포구 당산동3가 당산로 123",
        ...
        Office(name: "강남", tel: "02-3423-5114", address: "서울특별시 강남구 삼성2동 학동로 426",
    ...
    let taxOffice : [Office] = [
        ...
        Office(name: "역삼\n(강남 일부)", tel: "02-3011-8200", address: "서울특별시 강남구 테헤란로 114 역삼빌딩 7,8,9층",
        ...
        Office(name: "송파\n(송파 일부)", tel: "02-2224-9200", address: "서울특별시 송파구 강동대로 62",
        ...
        Office(name: "성동/광진", tel: "02-460-4200", address: "서울특별시 성동구 광나루로 297",
